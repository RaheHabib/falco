...
const Services = () => {
  ...
  return (
    <section className="relative px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 bg-white overflow-hidden">
      {/* Central Glow Effect */}
      ...
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8 lg:ml-48">
              {/* Technology Header */}
